                                    ...
                                    <div className="flex flex-row items-center p-5 gap-4">
                                        ...
                                        >
                                            ...
                                            <div className="min-w-0 flex-1">
                                                <div className="flex items-center gap-3">
                                                    <h3 className="text-base font-black text-foreground truncate tracking-tight group-hover:text-indigo-500 transition-colors uppercase">
                                                        {dataset.name}
                                                    </h3>
                                                    <Badge variant="outline" className="text-[10px] h-5 px-2 bg-muted/50 font-black text-muted-foreground/70 border-border group-hover:bg-background group-hover:text-indigo-500 transition-colors">
                                                        #{dataset.name.slice(0, 8).toUpperCase()}
                                                    </Badge>
                                                </div>
                                                <div className="flex items-center gap-2 mt-1.5">
                                                    <div className="h-1 w-1 rounded-full bg-indigo-500/50" />
                                                    <p className="text-[9px] text-muted-foreground/60 font-black uppercase tracking-widest">Active Discovery Asset</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="hidden sm:flex items-center gap-10 px-8 border-x border-border/60 cursor-pointer h-12" onClick={() => setSelectedDatasetName(dataset.name)}>
                                            ...
                                            <div className="flex flex-col gap-1 min-w-[70px]">
                                                <p className="text-[9px] uppercase font-black text-muted-foreground/40 tracking-widest">Engines</p>
                                                <div className="flex items-center gap-2">
                                                    <Layers className="h-3.5 w-3.5 text-emerald-500" />
                                                    <span className="text-sm font-black text-foreground tabular-nums">{dataset.trained_engines_count}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="hidden md:flex items-center gap-8 pr-6 cursor-pointer" onClick={() => setSelectedDatasetName(dataset.name)}>
                                            <div className="flex flex-col gap-1">
                                                <p className="text-[9px] uppercase font-black text-muted-foreground/30 tracking-tight">X-Space</p>
                                                <span className="text-[10px] font-black text-indigo-500 bg-indigo-500/5 px-2 py-0.5 rounded border border-indigo-500/20">{dataset.n_features}D</span>
                                            </div>
                                            <div className="flex flex-col gap-1">
                                                <p className="text-[9px] uppercase font-black text-muted-foreground/30 tracking-tight">y-Space</p>
                                                <span className="text-[10px] font-black text-emerald-500 bg-emerald-500/5 px-2 py-0.5 rounded border border-emerald-500/20">{dataset.n_objectives}D</span>
                                            </div>
                                        </div>
