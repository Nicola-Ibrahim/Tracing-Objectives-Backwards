        ...
        <div className="space-y-6 max-w-7xl mx-auto pb-10">
            ...
            <Tabs defaultValue="generation" className="space-y-6">
                <TabsList className="bg-slate-100 p-1">
                    ...
                    <TabsTrigger value="explorer" className="flex items-center gap-2" disabled={!result}>
                            ...
                            {result ? (
                                <Card className="border-indigo-100 shadow-md">
                                    <CardHeader className="bg-indigo-50/30 border-b border-indigo-100 py-4">
                                        <CardTitle className="text-sm font-bold text-indigo-900 uppercase tracking-wider">Quick Preview</CardTitle>
                                    </CardHeader>
                                    <CardContent className="p-6">
                                        <CandidateExplorer
                                            data={result}
