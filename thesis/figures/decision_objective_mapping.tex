...
\begin{scope}[xshift=7cm, local bounding box=objectiveBox]
    % Axes
    \draw[->, line width=1pt] (0,0) -- (4.5,0) node[below, axisLabel] {min $\leftarrow$ $f_1$ (Properties)};
    \draw[->, line width=1pt] (0,0) -- (0,4.5) node[left, axisLabel, rotate=90, anchor=south] {min $\leftarrow$  $f_2$};
