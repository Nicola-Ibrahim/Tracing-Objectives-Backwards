\begin{tikzpicture}[
    ...
    \begin{pgfonlayer}{main}
        ...
        \fill[dominanceRegion, opacity=0.15] (PF3) rectangle (\xmax, \ymax);
    ...
    \node[text=paretoBlue, font=\sffamily\bfseries, anchor=north east] at ($(PF5)+(0,-0.2)$) {Pareto Front (Non-dominated Set)};
