...
non-uniqueness and noisy data. Hyperparameters (including $\lambda$) are tuned by validation
...
\begin{figure}[H]
  ...
  \begin{adjustbox}{max width=\linewidth}
    \include{figures/deterministic_modeling}
...
\begin{figure}[tbp]
  \centering
  \begin{adjustbox}{max width=\linewidth}
    \include{figures/probabilistic_modeling}
  \end{adjustbox}
