...
\begin{figure}[h]
    ...
    \caption[Performance Scaling and Model Complexity]{Performance scaling across architectures. The figure highlights where additional capacity continues to improve target matching and where returns begin to diminish.}
...
\begin{figure}[!htbp]
    ...
    \caption[Model Calibration Analysis on BBOB Benchmarks]{Calibration curve (PIT empirical CDF vs.\ diagonal) for each model; optionally one panel per function.}
