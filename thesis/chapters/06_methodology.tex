...
\begin{figure}[!htbp]
  ...
  \end{adjustbox}
  \caption[Propose--Check Workflow Framework]{Propose--check workflow used throughout the thesis. An inverse model generates a candidate set for a target outcome, and an explicit evaluation stage scores and ranks candidates using a stated outcome evaluator and discrepancy.}
  \label{fig:framework}
\end{figure}
