...
from modules.modeling.application.train_inverse_model_cv.command import (
    TrainInverseModelCrossValidationCommand,
)
from modules.modeling.application.train_inverse_model_cv.handler import (
...
def cli(estimator: str, dataset_name: str) -> None:
    ...
    handler = TrainInverseModelCrossValidationCommandHandler(
