...
<<<<<<< HEAD:src/modules/optimization_engine/infrastructure/assurance/diversity/max_min_distance.py
...
>>>>>>> dev:src/modules/evaluation/infrastructure/diversity/max_min_distance.py
